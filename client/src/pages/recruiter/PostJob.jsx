...
import { Plus, Trash2, Eye, Edit3, ArrowLeft, Info, HelpCircle } from 'lucide-react';
    ...
    <div className="space-y-8 max-w-3xl mx-auto pb-12">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight">Post new Vacancy</h1>
            <p className="text-sm text-slate-400">Fill out details to publish a new open career opening.</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="glass-card p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <input
              type="text"
              placeholder="Add requirement (e.g. 5+ years of Python experience)"
              value={reqInput}
